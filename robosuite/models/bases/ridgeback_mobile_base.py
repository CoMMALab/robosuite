"""
Clearpath Robotics Ridgeback mobile base.
"""
import numpy as np
...
class RidgebackMobileBase(MobileBaseModel):
    """
    Clearpath Robotics Ridgeback mobile base.
    ...
    def __init__(self, idn=0):
            super().__init__(xml_path_completion("bases/ridgeback_mobile_base.xml"), idn=idn)
